                ...
                <div class="col-sm-12">
                    <div class="statistics-details d-flex align-items-center justify-content-between">
                        <div>
                            ...
                            <h3 class="rate-percentage">1920</h3>
                            <p class="text-danger d-flex"><i class="mdi mdi-menu-down"></i><span>-0.5%</span></p>
                        </div>
                        <div>
                            <p class="statistics-title">Artikel Views</p>
                            <h3 class="rate-percentage">7682</h3>
                            <p class="text-success d-flex"><i class="mdi mdi-menu-up"></i><span>+0.1%</span></p>
                        </div>
                        <div>
                            <p class="statistics-title">Tickets Sold</p>
                            <h3 class="rate-percentage">6800</h3>
                            <p class="text-danger d-flex"><i class="mdi mdi-menu-down"></i><span>68.8</span></p>
                        </div>
                        <div class="d-none d-md-block">
                            <p class="statistics-title">Cinema</p>
                ...
                <div class="col-lg-8 d-flex flex-column">
                    ...
                    <div class="col-12 col-lg-4 col-lg-12 grid-margin stretch-card">
                        ...
                        <div class="card-body">
                            ...
                            <div>
                                <h4 class="card-title card-title-dash">Penjualan Tiket</h4>
                            </div>
                ...
                <div class="col-lg-4 d-flex flex-column">
                    ...
                    <div class="col-md-6 col-lg-12 grid-margin stretch-card">
                        ...
                        <div class="card-body pb-0">
                            <h4 class="card-title card-title-dash text-white mb-4">Status LegionTix</h4>
                            <div class="row">
                                <div class="col-sm">
                                    <h2 class="text-info text-center">GOOD</h2>
                                </div>
                            </div>
                        </div>
                        </div>
                    ...
                    <div class="col-md-6 col-lg-12 grid-margin stretch-card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div>
                                    <p class="text-small mb-2">Avg Visitors</p>
